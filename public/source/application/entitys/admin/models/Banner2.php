...
class Admin_Model_Banner2 extends Core_Model
{
    ...
    public function findAllByType($idType, $visible = false, $replaceData = array()) {
        $select = $this->_tableBanner->getAdapter()->select()
                ->from(array('b' => $this->_tableBanner->getName()), 
                       array('b.idbanner', 'b.codtbanner', 'b.titulo', 'b.ImgAvanzado', 'b.ImgBasico128','b.ImgBasico240','b.ImgBasico360',
    ...
    public function insert($params) {
        $data = array();
        if(isset($params['ImgAvanzado'])) $data['ImgAvanzado'] = $params['ImgAvanzado'];
        if(isset($params['ImgBasico128'])) $data['ImgBasico128'] = $params['ImgBasico128'];
        if(isset($params['ImgBasico240'])) $data['ImgBasico240'] = $params['ImgBasico240'];
        if(isset($params['ImgBasico360'])) $data['ImgBasico360'] = $params['ImgBasico360'];
    ...
    public function deleteAll($notDelete = "", $idBannerType = "") {
      ...
      public function BannersAll() {
        $select = $this->_tableBanner->getAdapter()->select()
                        ->from($this->_tableBanner->getName(), array('titulo', 'url', 'codtbanner','ImgAvanzado','ImgBasico128','ImgBasico240','ImgBasico360','norder'))
